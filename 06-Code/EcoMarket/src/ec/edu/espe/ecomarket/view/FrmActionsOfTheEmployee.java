 ...
 */
public class FrmActionsOfTheEmployee extends javax.swing.JFrame {

    /**
     * Creates new form FmrActionsOfTheManager
     */
    public FrmActionsOfTheEmployee() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnRegisterProduct.setText("RegisterSale");
    ...
    private void btnRegisterProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterProductActionPerformed
        ...
        FrmRegisterSale registerProduct = new FrmRegisterSale();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmActionsOfTheEmployee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmActionsOfTheEmployee().setVisible(true);
            }
        });
    }
